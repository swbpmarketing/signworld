      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
        ...
        <div className="hidden lg:block lg:col-span-1 space-y-6">
          ...
          {stats.trendingTags.length > 0 && (
            <div data-tour="trending-tags" className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 p-6">
        ...
        >
          ...
          >
            ...
            {loadingThread ? (
              ...
              <div className="p-6">
                {/* Category and Status */}
                <div data-tour="pin-lock-thread" className="flex items-center gap-2 mb-4">
                  <span className="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-primary-100 dark:bg-primary-900/30 text-primary-700 dark:text-primary-400 capitalize">
