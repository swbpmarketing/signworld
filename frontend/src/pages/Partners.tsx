              ...
              {[1, 2, 3].map((i) => (
                <div key={i} className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 p-6">
                  <div className="flex items-start justify-between mb-4">
                    <div className="flex items-center">
                      <div className="h-16 w-16 rounded-lg animate-shimmer"></div>
                      <div className="ml-4 space-y-2">
                        <div className="h-6 rounded w-48 animate-shimmer"></div>
                  ...
                  <div className="flex gap-2 mt-4">
                    {[1, 2, 3, 4].map((j) => (
                      <div key={j} className="h-6 rounded w-20 animate-shimmer"></div>
                    ))}
                  </div>
                </div>
              ))}
