  ...
  return (
    <div className="space-y-8" data-tour="brags-content">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-4">
          <div className="min-w-0 flex-1">
            <h1 className="text-lg sm:text-xl md:text-2xl font-bold text-gray-900 dark:text-white">
              <TrophyIcon className="h-6 w-6 sm:h-8 sm:w-8 mr-2 inline-block" />
              Success Stories
            </h1>
            ...
            {canManage('successStories') && (
              ...
              >
                ...
                {pendingStories.length > 0 && (
                  <span className="ml-2 bg-white text-primary-600 text-xs font-bold px-2 py-0.5 rounded-full">
      ...
      {showDetailModal && selectedStory && (
        ...
        >
          <div
            className="bg-white dark:bg-gray-800 rounded-2xl max-w-3xl w-full max-h-[90vh] overflow-y-auto shadow-2xl [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]"
            onClick={(e) => e.stopPropagation()}
          >
            {/* Header */}
